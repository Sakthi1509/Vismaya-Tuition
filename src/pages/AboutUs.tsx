...
import heroAbout from "@/assets/four.jpg";
import teachingImg from "@/assets/five.jpg";
import teachingImg2 from "@/assets/six.jpg";
import teachingImg3 from "@/assets/seven.jpg";
      ...
      {sections.map((s, i) => (
        <div key={i} className="grid md:grid-cols-5 gap-8 items-start">
          ...
          <div className="md:col-span-2">
            <img src={s.image} alt={s.title} className="rounded-lg w-full h-48 md:h-64 object-cover shadow-md" />
          </div>
        </div>
      ))}
    </div>
